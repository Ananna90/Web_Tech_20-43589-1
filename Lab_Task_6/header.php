...
<body >
    ...
    <header>
<div class="nav">
    <li> <img src="img/Logo.jpeg"height="88px" width="100px"> </li>
    <li> <h2> MeditateLife </h2> </li>
       
 <li style="float:right"><a href="login.php"> Logout </a></li>


         <li style="float:right"><a href="ProfilePage.php"> Welcome, <?php echo $_SESSION["user"];?> | </a></li>


    <li style="float:right"><a href="ProfilePage.php"> View Profile </a></li>
    ...
    <div class="dropdown-content" name="About US">
      <br>
      <a href="director.php">Board of Directors</a>
